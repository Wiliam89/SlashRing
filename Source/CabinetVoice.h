...
{
public:
    // CORREÇÃO INTEGRAL: Construtor padrão restaurado para compatibilidade com a factory no CabinetEngine.
    ...
    void setPhysics (float cabSize, float openBack, float drive, float breakup) noexcept;
...
private:
    ...
    SpeakerNonLinearity speakerNonLinearity;
    CabinetPhysics cabinetPhysics;
    CabinetAcoustics cabinetAcoustics;
